...
class TerrainFeatureDetail:
    def __init__(self):
        self.generate(self.population_feature(), self.dangerous_feature(), self.use_feature(), self.event_feature(),
                      self.antagonists_feature(), self.quirk_feature())
    ...
    def generate(self, population, danger, use, event, antagonists, quirk):
